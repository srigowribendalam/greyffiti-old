...
export default class BadgesHeader extends Component {
    ...
    <div> {Data.details.map((data, id) => {
      return(
        <div className="header">
          <Link to="/">
          <img src={logo} className="_headerlogo"/>
          </Link>
        <div>
        <Form.Control  className="form width" placeholder="Search posts, hashtags, categories.." /><img src={search} style={{marginLeft:"92%",marginTop:"-3.9rem",width:"20px"}}/>
        </div>
