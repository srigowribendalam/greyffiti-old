...
export default class Login extends Component {
    ...
    render() {
        return (
            <div>
                {/* <img src={logo} style={{width:"4%",marginLeft:"5rem",marginTop:"1.5rem"}}/> */}
          ...
          <Col sm={5}>
            <div className="login">
              ...
              <Form onSubmit={this.handleSubmit}>
                ...
                <Row style={{ width: "100%" }}>
                    <Col md={6}>
                        <img src={login} style={{ opacity:"0.5",height: "578px", width: "100%" }} />
                        <Link to="/">
                        <div className="logo">
                            <img src={logo} style={{width:"80%"}}/></div></Link>
                            <h3 className="heading">Let's Create<br/>something<br/> amazing with Us.</h3>
                    </Col>
                    <Col md={6} style={{ marginTop: "2rem" }}>
                        <p style={{ float: "right" }}>Already a member? <Link to ="/login"><span style={{ color: "red" }}> Sign in</span></Link> &nbsp; &nbsp; <FaEllipsisV /></p>
                        <div className="login">
                            <h4>Sign up to Graffiti.</h4>
                            <Form onSubmit={this.handleSubmit}>
                                <>
                                    <Button
                                        size="md"
                                    ...
                                    <Button
                                        variant="secondary" size="md" className="ml-3"
                                        style={{ backgroundColor: "#EEF4FE", color: "black", borderColor: "#EEF4FE" }}
                                    >
                                        With Facebook
                </Button>
                                </><br />
                                ...
                                <Col md={1}>
                                       <input type="checkbox" />
                                         ...
                                         <Col md={11}>
                                          <label style={{marginLeft:"-1.5rem"}}><span style={{color:"grey"}}>Creating an account means you're okay with our </span><span style={{color:"red"}}>Terms of service, Privacy Policy, </span><span style={{color:"grey"}}>and our default </span><span style={{color:"red"}}>Notification settings</span></label>
